package com.github.darmoise.springamqpexample.consumerservice1.configuration;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.darmoise.springamqpexample.consumerservice1.configuration.properties.RabbitProperties;
...
public class RabbitConfiguration {
    ...
    public Queue defaultQueue() {
        return new Queue(properties.getQueues().getDefaultQueue());
    }
    ...
    public Binding bindingFanoutBinding(
        ...
        return BindingBuilder.bind(fanoutQueue)
            .to(producerServiceFanoutExchange);
    }
